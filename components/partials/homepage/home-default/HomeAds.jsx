            ...
            <div className="ps-container">
                <div className="row">
                    <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 ">
                        <Promotion
                            link="#"
                            image="https://res.cloudinary.com/dv1jydljf/image/upload/v1644572436/ban5_u11kbv.jpg"
                        />
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <Promotion
                            link="#"
                            image="https://res.cloudinary.com/dv1jydljf/image/upload/v1644572430/teaSet_yheat8.jpg"
                        />
                    </div>
                </div>
            </div>
